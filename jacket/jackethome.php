...
<div class="introduction desktophomejacket" id="singlejacket" style="margin-top:0px !important;">
  ...
  <div class="col-xs-12 text-center header" style="top: 25%;">
            ...
            <center>                  
                <?php if ($jacket_home_url) { ?>
                	<a target="_blank" href="<?php echo esc_url($jacket_home_url); ?>">
				<?php } ?>                    
                  	<img style="margin-top:0px; height:auto;" src="<?php echo esc_url($jacket_home_image); ?>" class="aligncenter img-responsive" />
				<?php if ($jacket_home_url) { ?>
	                </a>
				<?php } ?>
			</center>                    
  ...
  <div class="col-xs-12 text-center header" style="top:0%;">
            ...
            <center>                              
                ...
                <?php if ($jacket_home_url) { ?>
                	<a target="_blank" href="<?php echo esc_url($jacket_home_url); ?>">
				<?php } ?>                    
    		            <img style="margin-top:0px; height:auto;" src="<?php echo esc_url($jacket_home_image_mobile); ?>" class="aligncenter img-responsive" />
				<?php if ($jacket_home_url) { ?>
	                </a>
				<?php } ?>
